...
//	 primary key((id, type),name, startdate, enddate) );
	...
	public ProjectId(String type, String name, LocalDate startdate, LocalDate enddate) {
		super();
		id =UUID.randomUUID();
		this.type = type;
		this.name = name;
	...
	public ProjectId(UUID id, String type, String name, LocalDate startdate, LocalDate enddate) {
		super();
