...
@Configuration
@ComponentScan("vn.ifisolution.fresher12.*")
//@PropertySources({ @PropertySource("classpath:datasource-cfg.properties") })
@EnableCassandraRepositories(basePackages = { "vn.ifisolution.fresher12.repositories" })
...
//	@Bean
//	@Primary
//	@ConfigurationProperties(prefix="data.cassandra")
//	public DataSourceProperties dataSourceCassandraProperties(){
