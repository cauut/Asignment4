package vn.ifisolution.fresher12.IOT_CTHV.configuration;
...
@Configuration
@ComponentScan("vn.ifisolution.fresher12.IOT_CTHV.*")
@EnableCassandraRepositories(basePackages = { "vn.ifisolution.fresher12.IOT_CTHV.repositories" })
